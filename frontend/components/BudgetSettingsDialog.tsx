...
export default function BudgetSettingsDialog({ open, onClose, month, year }: BudgetSettingsDialogProps) {
  ...
  const fetchBudgetCategories = async () => {
    try {
      const [budgetsRes, summaryRes] = await Promise.all([
        budgetCategoriesAPI.getAll(month, year),
