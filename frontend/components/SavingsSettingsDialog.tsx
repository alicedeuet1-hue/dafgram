...
interface SavingsSettingsDialogProps {
  open: boolean;
  onClose: () => void;
  month: number;
  year: number;
...
export default function SavingsSettingsDialog({ open, onClose, month, year }: SavingsSettingsDialogProps) {
